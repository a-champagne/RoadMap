...
public class ManagerViewMaintenanceRequest extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manager_maintenance_request);
    ...
    public void setResolved(View view) {
        ...
        database.getReference("Maintenance_Alerts").child(this.vehicleID).child(this.requestID).child("Status").setValue("Closed");
